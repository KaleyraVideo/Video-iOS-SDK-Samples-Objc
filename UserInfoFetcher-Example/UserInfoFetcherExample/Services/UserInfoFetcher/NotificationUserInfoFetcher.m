...
@interface NotificationUserInfoFetcher()
...
@implementation NotificationUserInfoFetcher
...
{
    NotificationUserInfoFetcher *copy = (NotificationUserInfoFetcher *) [[[self class] allocWithZone:zone] init];
