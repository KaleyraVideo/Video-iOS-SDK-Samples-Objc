...
NSString *NSStringFromPublishMode(PublishMode mode) {
    switch (mode)
    {
...
@implementation PublishSettings
...
- (instancetype)initWithCoder:(NSCoder *)coder
{
    ...
    if (self)
    {
        self.mode = (PublishMode) [coder decodeIntForKey:MODE_KEY];
...
{
    [coder encodeInt:self.mode forKey:MODE_KEY];
...
- (NSString *)description
{
    ...
    [description appendFormat:@"mode %@", NSStringFromPublishMode(self.mode)];
