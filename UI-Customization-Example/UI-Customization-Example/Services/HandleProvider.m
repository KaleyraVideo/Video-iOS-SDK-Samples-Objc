...
- (void)handleForAliases:(nullable NSArray<NSString *> *)aliases completion:(nonnull void (^)(CXHandle * _Nonnull))completion API_AVAILABLE(ios(10.0))
{
    if (aliases.count == 0)
    {
...
- (CXHandle *)_makeHandle:(NSString *)value API_AVAILABLE(ios(10.0))
{
